...
class RemindersLocalRepositoryTest {
    ...
    val list =  listOf<ReminderDTO>(ReminderDTO("india", "New-Delhi","khanmarket",(-360..360).random().toDouble(),(-360..360).random().toDouble()),
            ReminderDTO("india", "TajMahal","agrakant",(-360..360).random().toDouble(),(-360..360).random().toDouble()),
            ReminderDTO("india", "Bangalore","khanmarket",(-360..360).random().toDouble(),(-360..360).random().toDouble()),
            ReminderDTO("india", "uttrakhand","ranikeht",(-360..360).random().toDouble(),(-360..360).random().toDouble()))
